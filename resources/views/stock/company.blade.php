...
@section('content')
    ...
    <x-site name="Company" body="Add Company">
        <x-slot name="header">
            @can('Product Company Create')
                <button id="headerBtn" type="button" class="btn btn-primary heading-btn btn-labeled btn-labeled-left" data-toggle="modal" data-target="#myModal"><b><i class="icon-add-to-list"></i></b> Add New Company</button>
            @endcan
        </x-slot>
