@section('box')
    ...
    <x-modal id="customerModal" action="{{route('customer.store')}}" size="modal-full" title="Add New Customer" icon="grid5">
        <div class="row">
            <div class="col-md-6">
                ...
                <x-select class="zilla" name="zillas_id" label="District" required="required" >
