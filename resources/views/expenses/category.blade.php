    ...
    <x-site name="Expenses Category" body="Add New Expenses Category">
        ...
        <table class="table table-striped table-condensed table-hover datatable-basic">
            ...
            <tr>
                ...
                <th class="p-th">Expense Category Name</th>
                    ...
                    <td class="text-right p-td">
                        <x-actions>
                            @can('Expense Category Edit')
                                <li><a href="{{route('expense-category.update', ['category' => $row->id])}}"
                                   data-name="{{$row->name}}"
                                   data-code="{{$row->code}}"
                            ...
                            @can('Expense Category Delete')
                                <li><a href="{{route('expense-category.destroy', ['category' => $row->id])}}" class="delItem"><i class="icon-bin text-danger"></i> Delete</a></li>
                            @endcan
                        </x-actions>
                    </td>
                </tr>
